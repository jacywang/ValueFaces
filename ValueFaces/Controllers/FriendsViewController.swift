...
class FriendsViewController: UIViewController, PFLogInViewControllerDelegate, PFSignUpViewControllerDelegate {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        // No user logged in
        let signupButtonBackgroundImage: UIImage = getImageWithColor(UIColor.manicCravingColor(), size: CGSize(width: 10.0, height: 10.0))
        ...
        self.logInViewController.fields = PFLogInFields.Default
